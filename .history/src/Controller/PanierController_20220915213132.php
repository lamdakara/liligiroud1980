...
class PanierController extends AbstractController
{
    ...
    public function index(BookingRepository $bookingRepository, StripePayment $stripePayment, ParameterBagInterface $param): Response
    {
...
dd($publicKey);
        ...
        $intent = $this->stripePayment->paymentIntent($total);
